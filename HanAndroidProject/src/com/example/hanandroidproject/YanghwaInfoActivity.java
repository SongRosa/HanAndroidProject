...
public class YanghwaInfoActivity extends NMapActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_yanghwainfo);
		// create map view

		Intent intent = getIntent();
		int p_number = intent.getIntExtra("p_number", 7);

		mMapView = new NMapView(this);
		MapContainer = (LinearLayout) findViewById(R.id.yanghwainfomap);
	...
	public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
		if (errorInfo == null) { // success
			...
			if (size==0) {
				...
				poiData.addPOIitem(126.8925002, 37.5446259, "양화한강공원", markerId,0);
				poiData.endPOIdata();
			}
	...
	private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
		...
		public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay,
			...
			Toast.makeText(YanghwaInfoActivity.this,"onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
		}
