...
public class NanjiInfoActivity extends NMapActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_nanjiinfo);
		// create map view

		Intent intent = getIntent();
		int p_number = intent.getIntExtra("p_number", 3);

		mMapView = new NMapView(this);
		MapContainer = (LinearLayout) findViewById(R.id.nanjiinfomap);
	...
	public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
		if (errorInfo == null) { // success
			...
			if (size==0) {
				...
				poiData.addPOIitem(126.8744075, 37.5672574, "난지한강공원", markerId,0);
				poiData.endPOIdata();
			}
	...
	private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
		...
		public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay,
			...
			Toast.makeText(NanjiInfoActivity.this,"onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
		}
