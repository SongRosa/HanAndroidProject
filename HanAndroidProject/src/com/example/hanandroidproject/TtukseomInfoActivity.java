...
public class TtukseomInfoActivity extends NMapActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ttukseominfo);
		// create map view

		Intent intent = getIntent();
		int p_number = intent.getIntExtra("p_number", 4);

		mMapView = new NMapView(this);
		MapContainer = (LinearLayout) findViewById(R.id.ttukseominfomap);
	...
	public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
		if (errorInfo == null) { // success
			...
			if (size==0) {
				...
				poiData.addPOIitem(127.0706769, 37.5294517, "뚝섬한강공원", markerId,0);
				poiData.endPOIdata();
			}
	...
	private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
		...
		public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay,
			...
			Toast.makeText(TtukseomInfoActivity.this,"onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
		}
