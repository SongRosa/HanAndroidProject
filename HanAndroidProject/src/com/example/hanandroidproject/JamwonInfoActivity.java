...
public class JamwonInfoActivity extends NMapActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jamwoninfo);
		// create map view

		Intent intent = getIntent();
		int p_number = intent.getIntExtra("p_number", 11);

		mMapView = new NMapView(this);
		MapContainer = (LinearLayout) findViewById(R.id.jamwoninfomap);
	...
	public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
		if (errorInfo == null) { // success
			...
			if (size==0) {
				...
				poiData.addPOIitem(127.0130935, 37.5225934, "잠원한강공원", markerId,0);
				poiData.endPOIdata();
			}
	...
	private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
		...
		public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay,
			...
			Toast.makeText(JamwonInfoActivity.this,"onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
		}
