...
public class KwangnaruInfoActivity extends NMapActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_kwangnaruinfo);
		// create map view

		Intent intent = getIntent();
		int p_number = intent.getIntExtra("p_number", 2);

		mMapView = new NMapView(this);
		MapContainer = (LinearLayout) findViewById(R.id.kwangnaruinfomap);
	...
	public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
		if (errorInfo == null) { // success
			...
			if (size==0) {
				...
				poiData.addPOIitem(127.1245699, 37.5583388, "광나루한강공원", markerId,0);
				poiData.endPOIdata();
			}
	...
	private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
		...
		public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay,
			...
			Toast.makeText(KwangnaruInfoActivity.this,"onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
		}
